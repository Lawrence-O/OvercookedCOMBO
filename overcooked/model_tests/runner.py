import sys
from overcooked.model_tests.test_classes import ActionProposalTester, DatasetTester, IverseDynamicsTester, RewardModelValidator, WorldModelTester, \
...
def main():
    ...
    args.n_envs = 2
    args.population_yaml_path = "Overcooked_Population_Data/custom/sp_vs_best_r_sp_config.yml"
